...
ปัญหาหลักของแก๊งคอลเซ็นเตอร์คือการเปิดซิมใหม่เปลี่ยนเบอร์ตลอดเวลาทำให้ระบบฐานข้อมูลเดิมตามไม่ทัน เราจึงพัฒนาระบบจำลองชิป Samsung ที่สามารถตรวจสอบเสียงสนทนาได้ทันทีขณะคุยสายและส่งข้อมูลให้ AI ภาษาไทยช่วยจับใจความและบริบทของคำพูดเพื่อแยกแยะมิจฉาชีพ หากระบบประเมินแล้วว่าเป็นแก๊งคอลเซ็นเตอร์จริง จะแจ้งเตือนให้ผู้ใช้กดบล็อกเบอร์และส่งข้อมูลกลับไปบันทึกในฐานข้อมูล Samsung ทันที พร้อมส่งการแจ้งเตือนผ่าน LINE BOT และยิงระบบ API ไปสั่งปิดการโอนเงินของแอปธนาคาร K PLUS ชั่วคราว (10 นาที) และสามารถปลดล็อคได้โดยการสแกนใบหน้าหรือการเข้ารหัส (กรณีฉุกเฉิน) รวมถึงส่งเลขบัญชีม้าให้ทาง KBTG โดยหลังจากการตรวจพบบริบทของบทสนทนาโดย AI และ KBTG ทำการตรวจสอบและอายัด เป็นการป้องกันภัยทางการเงินแบบที่ปกป้องผู้ใช้ได้จริง
